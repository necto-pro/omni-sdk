...
- 91dc4296: chore (@omni-stack/anthropic): remove anthropic-beta header

## 0.0.24

### Patch Changes

- 04800838: fix (@omni-stack/anthropic): combine tool and user messages, combine system messages
...
- 0a22b05b: feat (@omni-stack/anthropic): add claude-3.5-sonnet model
...
- 09295e2e: feat (@omni-stack/anthropic): automatically download image URLs
