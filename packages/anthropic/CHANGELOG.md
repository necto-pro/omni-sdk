...
- 91dc4296: chore (@open-stack/anthropic): remove anthropic-beta header

## 0.0.24

### Patch Changes

- 04800838: fix (@open-stack/anthropic): combine tool and user messages, combine system messages
...
- 0a22b05b: feat (@open-stack/anthropic): add claude-3.5-sonnet model
...
- 09295e2e: feat (@open-stack/anthropic): automatically download image URLs
