...
```bash
npm install @open-stack/provider @open-stack/provider-utils
```
...
import { ProviderV3 } from '@open-stack/provider';
...
import { LanguageModelV3, LanguageModelV3CallOptions } from '@open-stack/provider';
import { postJsonToApi } from '@open-stack/provider-utils';
...
- Explore the V2 types in detail at [`@open-stack/provider`](https://github.com/vercel/ai/tree/main/packages/provider/src/language-model/V2)
