...
```bash
npm install @omni-stack/provider @omni-stack/provider-utils
```
...
import { postJsonToApi } from '@omni-stack/provider-utils';
...
- Explore the V2 types in detail at [`@omni-stack/provider`](https://github.com/vercel/ai/tree/main/packages/provider/src/language-model/V2)
