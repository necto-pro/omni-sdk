...
You can use the [OpenAI Compatible Provider](https://www.npmjs.com/package/@omni-stack/openai-compatible) package to use language model providers that implement the OpenAI API.
...
The OpenAI Compatible provider is available via the `@omni-stack/openai-compatible` module. You can install it with:

<Tabs items={['pnpm', 'npm', 'yarn', 'bun']}>
  <Tab>
    <Snippet text="pnpm add @omni-stack/openai-compatible" dark />
  </Tab>
  <Tab>
    <Snippet text="npm install @omni-stack/openai-compatible" dark />
  </Tab>
  <Tab>
    <Snippet text="yarn add @omni-stack/openai-compatible" dark />
  </Tab>

  <Tab>
    <Snippet text="bun add @omni-stack/openai-compatible" dark />
  </Tab>
</Tabs>

## Provider Instance

To use an OpenAI compatible provider, you can create a custom provider instance with the `createOpenAICompatible` function from `@omni-stack/openai-compatible`:
