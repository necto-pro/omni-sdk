...
You can use the [OpenAI Compatible Provider](https://www.npmjs.com/package/@open-stack/openai-compatible) package to use language model providers that implement the OpenAI API.
...
The OpenAI Compatible provider is available via the `@open-stack/openai-compatible` module. You can install it with:

<Tabs items={['pnpm', 'npm', 'yarn', 'bun']}>
  <Tab>
    <Snippet text="pnpm add @open-stack/openai-compatible" dark />
  </Tab>
  <Tab>
    <Snippet text="npm install @open-stack/openai-compatible" dark />
  </Tab>
  <Tab>
    <Snippet text="yarn add @open-stack/openai-compatible" dark />
  </Tab>

  <Tab>
    <Snippet text="bun add @open-stack/openai-compatible" dark />
  </Tab>
</Tabs>

## Provider Instance

To use an OpenAI compatible provider, you can create a custom provider instance with the `createOpenAICompatible` function from `@open-stack/openai-compatible`:
