...
The Baseten provider is available via the `@omni-stack/baseten` module. You can install it with

<Tabs items={['pnpm', 'npm', 'yarn']}>
  <Tab>
    <Snippet text="pnpm add @omni-stack/baseten" dark />
  </Tab>
  <Tab>
    <Snippet text="npm install @omni-stack/baseten" dark />
  </Tab>
  <Tab>
    <Snippet text="yarn add @omni-stack/baseten" dark />
  </Tab>
</Tabs>
...
If you need a customized setup, you can import `createBaseten` from `@omni-stack/baseten`
...
```ts
import { createBaseten } from '@omni-stack/baseten';
import { embed, embedMany } from '@omni-stack/core';
