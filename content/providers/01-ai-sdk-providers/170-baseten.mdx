...
The Baseten provider is available via the `@open-stack/baseten` module. You can install it with

<Tabs items={['pnpm', 'npm', 'yarn']}>
  <Tab>
    <Snippet text="pnpm add @open-stack/baseten" dark />
  </Tab>
  <Tab>
    <Snippet text="npm install @open-stack/baseten" dark />
  </Tab>
  <Tab>
    <Snippet text="yarn add @open-stack/baseten" dark />
  </Tab>
</Tabs>
...
If you need a customized setup, you can import `createBaseten` from `@open-stack/baseten`
