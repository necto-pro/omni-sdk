...
The Fal provider is available via the `@omni-stack/fal` module. You can install it with

<Tabs items={['pnpm', 'npm', 'yarn', 'bun']}>
  <Tab>
    <Snippet text="pnpm add @omni-stack/fal" dark />
  </Tab>
  <Tab>
    <Snippet text="npm install @omni-stack/fal" dark />
  </Tab>
  <Tab>
    <Snippet text="yarn add @omni-stack/fal" dark />
  </Tab>

  <Tab>
    <Snippet text="bun add @omni-stack/fal" dark />
  </Tab>
</Tabs>
...
```ts
import { createFal } from '@omni-stack/fal';
