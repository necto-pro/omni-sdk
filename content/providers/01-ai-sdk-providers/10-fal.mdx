...
The Fal provider is available via the `@open-stack/fal` module. You can install it with

<Tabs items={['pnpm', 'npm', 'yarn', 'bun']}>
  <Tab>
    <Snippet text="pnpm add @open-stack/fal" dark />
  </Tab>
  <Tab>
    <Snippet text="npm install @open-stack/fal" dark />
  </Tab>
  <Tab>
    <Snippet text="yarn add @open-stack/fal" dark />
  </Tab>

  <Tab>
    <Snippet text="bun add @open-stack/fal" dark />
  </Tab>
</Tabs>
...
```ts
import { createFal } from '@open-stack/fal';
