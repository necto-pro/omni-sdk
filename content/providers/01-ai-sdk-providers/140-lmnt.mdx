...
<Tabs items={['pnpm', 'npm', 'yarn', 'bun']}>
  <Tab>
    <Snippet text="pnpm add @open-stack/lmnt" dark />
  </Tab>
  <Tab>
    <Snippet text="npm install @open-stack/lmnt" dark />
  </Tab>
  <Tab>
    <Snippet text="yarn add @open-stack/lmnt" dark />
  </Tab>

  <Tab>
    <Snippet text="bun add @open-stack/lmnt" dark />
  </Tab>
</Tabs>
...
If you need a customized setup, you can import `createLMNT` from `@open-stack/lmnt` and create a provider instance with your settings:

```ts
import { createLMNT } from '@open-stack/lmnt';
