...
<Tabs items={['pnpm', 'npm', 'yarn', 'bun']}>
  <Tab>
    <Snippet text="pnpm add @omni-stack/lmnt" dark />
  </Tab>
  <Tab>
    <Snippet text="npm install @omni-stack/lmnt" dark />
  </Tab>
  <Tab>
    <Snippet text="yarn add @omni-stack/lmnt" dark />
  </Tab>

  <Tab>
    <Snippet text="bun add @omni-stack/lmnt" dark />
  </Tab>
</Tabs>
...
If you need a customized setup, you can import `createLMNT` from `@omni-stack/lmnt` and create a provider instance with your settings:

```ts
import { createLMNT } from '@omni-stack/lmnt';
