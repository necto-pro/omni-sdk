...
The Fireworks provider is available via the `@open-stack/fireworks` module. You can install it with

<Tabs items={['pnpm', 'npm', 'yarn', 'bun']}>
  <Tab>
    <Snippet text="pnpm add @open-stack/fireworks" dark />
  </Tab>
  <Tab>
    <Snippet text="npm install @open-stack/fireworks" dark />
  </Tab>
  <Tab>
    <Snippet text="yarn add @open-stack/fireworks" dark />
  </Tab>

  <Tab>
    <Snippet text="bun add @open-stack/fireworks" dark />
  </Tab>
</Tabs>
...
If you need a customized setup, you can import `createFireworks` from `@open-stack/fireworks`
and create a provider instance with your settings:

```ts
import { createFireworks } from '@open-stack/fireworks';
