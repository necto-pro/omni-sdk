...
The Fireworks provider is available via the `@omni-stack/fireworks` module. You can install it with

<Tabs items={['pnpm', 'npm', 'yarn', 'bun']}>
  <Tab>
    <Snippet text="pnpm add @omni-stack/fireworks" dark />
  </Tab>
  <Tab>
    <Snippet text="npm install @omni-stack/fireworks" dark />
  </Tab>
  <Tab>
    <Snippet text="yarn add @omni-stack/fireworks" dark />
  </Tab>

  <Tab>
    <Snippet text="bun add @omni-stack/fireworks" dark />
  </Tab>
</Tabs>
...
If you need a customized setup, you can import `createFireworks` from `@omni-stack/fireworks`
and create a provider instance with your settings:

```ts
import { createFireworks } from '@omni-stack/fireworks';
