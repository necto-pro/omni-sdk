...
The DeepInfra provider is available via the `@open-stack/deepinfra` module. You can install it with:

<Tabs items={['pnpm', 'npm', 'yarn', 'bun']}>
  <Tab>
    <Snippet text="pnpm add @open-stack/deepinfra" dark />
  </Tab>
  <Tab>
    <Snippet text="npm install @open-stack/deepinfra" dark />
  </Tab>
  <Tab>
    <Snippet text="yarn add @open-stack/deepinfra" dark />
  </Tab>

  <Tab>
    <Snippet text="bun add @open-stack/deepinfra" dark />
  </Tab>
</Tabs>
...
If you need a customized setup, you can import `createDeepInfra` from `@open-stack/deepinfra` and create a provider instance with your settings:

```ts
import { createDeepInfra } from '@open-stack/deepinfra';
