...
The DeepInfra provider is available via the `@omni-stack/deepinfra` module. You can install it with:

<Tabs items={['pnpm', 'npm', 'yarn', 'bun']}>
  <Tab>
    <Snippet text="pnpm add @omni-stack/deepinfra" dark />
  </Tab>
  <Tab>
    <Snippet text="npm install @omni-stack/deepinfra" dark />
  </Tab>
  <Tab>
    <Snippet text="yarn add @omni-stack/deepinfra" dark />
  </Tab>

  <Tab>
    <Snippet text="bun add @omni-stack/deepinfra" dark />
  </Tab>
</Tabs>
...
If you need a customized setup, you can import `createDeepInfra` from `@omni-stack/deepinfra` and create a provider instance with your settings:

```ts
import { createDeepInfra } from '@omni-stack/deepinfra';
