...
The Perplexity provider is available via the `@omni-stack/perplexity` module. You can install it with:

<Tabs items={['pnpm', 'npm', 'yarn', 'bun']}>
  <Tab>
    <Snippet text="pnpm add @omni-stack/perplexity" dark />
  </Tab>
  <Tab>
    <Snippet text="npm install @omni-stack/perplexity" dark />
  </Tab>
  <Tab>
    <Snippet text="yarn add @omni-stack/perplexity" dark />
  </Tab>

  <Tab>
    <Snippet text="bun add @omni-stack/perplexity" dark />
  </Tab>
</Tabs>
...
```ts
import { createPerplexity } from '@omni-stack/perplexity';
