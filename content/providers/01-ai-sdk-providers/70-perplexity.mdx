...
The Perplexity provider is available via the `@open-stack/perplexity` module. You can install it with:

<Tabs items={['pnpm', 'npm', 'yarn', 'bun']}>
  <Tab>
    <Snippet text="pnpm add @open-stack/perplexity" dark />
  </Tab>
  <Tab>
    <Snippet text="npm install @open-stack/perplexity" dark />
  </Tab>
  <Tab>
    <Snippet text="yarn add @open-stack/perplexity" dark />
  </Tab>

  <Tab>
    <Snippet text="bun add @open-stack/perplexity" dark />
  </Tab>
</Tabs>
...
```ts
import { createPerplexity } from '@open-stack/perplexity';
