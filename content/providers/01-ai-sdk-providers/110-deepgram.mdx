...
<Tabs items={['pnpm', 'npm', 'yarn', 'bun']}>
  <Tab>
    <Snippet text="pnpm add @open-stack/deepgram" dark />
  </Tab>
  <Tab>
    <Snippet text="npm install @open-stack/deepgram" dark />
  </Tab>
  <Tab>
    <Snippet text="yarn add @open-stack/deepgram" dark />
  </Tab>

  <Tab>
    <Snippet text="bun add @open-stack/deepgram" dark />
  </Tab>
</Tabs>
...
If you need a customized setup, you can import `createDeepgram` from `@open-stack/deepgram` and create a provider instance with your settings:

```ts
import { createDeepgram } from '@open-stack/deepgram';
