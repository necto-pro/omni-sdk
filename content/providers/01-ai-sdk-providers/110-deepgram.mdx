...
<Tabs items={['pnpm', 'npm', 'yarn', 'bun']}>
  <Tab>
    <Snippet text="pnpm add @omni-stack/deepgram" dark />
  </Tab>
  <Tab>
    <Snippet text="npm install @omni-stack/deepgram" dark />
  </Tab>
  <Tab>
    <Snippet text="yarn add @omni-stack/deepgram" dark />
  </Tab>

  <Tab>
    <Snippet text="bun add @omni-stack/deepgram" dark />
  </Tab>
</Tabs>
...
If you need a customized setup, you can import `createDeepgram` from `@omni-stack/deepgram` and create a provider instance with your settings:

```ts
import { createDeepgram } from '@omni-stack/deepgram';
