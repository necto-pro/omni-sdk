...
import { generateText, gateway } from '@omni-stack/core';
...
```ts
import { gateway } from '@omni-stack/core';
```
...
```ts
import { createGateway } from '@omni-stack/core';
...
```ts
import { gateway, generateText } from '@omni-stack/core';
...
```ts
import type { AnthropicProviderOptions } from '@omni-stack/anthropic';
import type { GatewayProviderOptions } from '@omni-stack/gateway';
import { generateText } from '@omni-stack/core';
