...
The Azure OpenAI provider is available in the `@omni-stack/azure` module. You can install it with

<Tabs items={['pnpm', 'npm', 'yarn', 'bun']}>
  <Tab>
    <Snippet text="pnpm add @omni-stack/azure" dark />
  </Tab>
  <Tab>
    <Snippet text="npm install @omni-stack/azure" dark />
  </Tab>
  <Tab>
    <Snippet text="yarn add @omni-stack/azure" dark />
  </Tab>

  <Tab>
    <Snippet text="bun add @omni-stack/azure" dark />
  </Tab>
</Tabs>
...
If you need a customized setup, you can import `createAzure` from `@omni-stack/azure` and create a provider instance with your settings:
...
```ts
import { azure } from '@omni-stack/azure';
import { wrapLanguageModel, extractReasoningMiddleware } from '@omni-stack/core';
...
```ts
import { azure, OpenAIResponsesProviderOptions } from '@omni-stack/azure';
import { generateText } from '@omni-stack/core';
