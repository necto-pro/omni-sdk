...
The Azure OpenAI provider is available in the `@open-stack/azure` module. You can install it with

<Tabs items={['pnpm', 'npm', 'yarn', 'bun']}>
  <Tab>
    <Snippet text="pnpm add @open-stack/azure" dark />
  </Tab>
  <Tab>
    <Snippet text="npm install @open-stack/azure" dark />
  </Tab>
  <Tab>
    <Snippet text="yarn add @open-stack/azure" dark />
  </Tab>

  <Tab>
    <Snippet text="bun add @open-stack/azure" dark />
  </Tab>
</Tabs>
...
If you need a customized setup, you can import `createAzure` from `@open-stack/azure` and create a provider instance with your settings:
...
```ts
import { azure, OpenAIResponsesProviderOptions } from '@open-stack/azure';
import { generateText } from 'ai';
