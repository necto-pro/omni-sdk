...
The Google provider is available in the `@omni-stack/google` module. You can install it with

<Tabs items={['pnpm', 'npm', 'yarn', 'bun']}>
  <Tab>
    <Snippet text="pnpm add @omni-stack/google" dark />
  </Tab>
  <Tab>
    <Snippet text="npm install @omni-stack/google" dark />
  </Tab>
  <Tab>
    <Snippet text="yarn add @omni-stack/google" dark />
  </Tab>

  <Tab>
    <Snippet text="bun add @omni-stack/google" dark />
  </Tab>
</Tabs>
...
If you need a customized setup, you can import `createGoogleGenerativeAI` from `@omni-stack/google` and create a provider instance with your settings:
...
<Note>
  Usage metadata was added to `providerMetadata` in `@omni-stack/google@1.2.23`. If
...
import { google } from '@omni-stack/google';
import { GoogleGenerativeAIProviderMetadata } from '@omni-stack/google';
import { generateText } from '@omni-stack/core';
    ...
    "groundingSupports": [
        {
            "segment": {
                "startIndex": 67,
                "endIndex": 157,
                "text": "**Installation**: Install the `@omni-stack/google` module using your preferred package manager"
            },
...
```ts
import { google } from '@omni-stack/google';
import { GoogleGenerativeAIImageProviderOptions } from '@omni-stack/google';
import { experimental_generateImage as generateImage } from '@omni-stack/core';
