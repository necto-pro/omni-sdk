...
The Google provider is available in the `@open-stack/google` module. You can install it with

<Tabs items={['pnpm', 'npm', 'yarn', 'bun']}>
  <Tab>
    <Snippet text="pnpm add @open-stack/google" dark />
  </Tab>
  <Tab>
    <Snippet text="npm install @open-stack/google" dark />
  </Tab>
  <Tab>
    <Snippet text="yarn add @open-stack/google" dark />
  </Tab>

  <Tab>
    <Snippet text="bun add @open-stack/google" dark />
  </Tab>
</Tabs>
...
If you need a customized setup, you can import `createGoogleGenerativeAI` from `@open-stack/google` and create a provider instance with your settings:
...
<Note>
  Usage metadata was added to `providerMetadata` in `@open-stack/google@1.2.23`. If
...
import { google } from '@open-stack/google';
import { GoogleGenerativeAIProviderMetadata } from '@open-stack/google';
import { generateText } from 'ai';
    ...
    "groundingSupports": [
        {
            "segment": {
                "startIndex": 67,
                "endIndex": 157,
                "text": "**Installation**: Install the `@open-stack/google` module using your preferred package manager"
            },
...
```ts
import { google } from '@open-stack/google';
import { GoogleGenerativeAIImageProviderOptions } from '@open-stack/google';
import { experimental_generateImage as generateImage } from 'ai';
