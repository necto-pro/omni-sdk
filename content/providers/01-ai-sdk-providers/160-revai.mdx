...
<Tabs items={['pnpm', 'npm', 'yarn', 'bun']}>
  <Tab>
    <Snippet text="pnpm add @omni-stack/revai" dark />
  </Tab>
  <Tab>
    <Snippet text="npm install @omni-stack/revai" dark />
  </Tab>
  <Tab>
    <Snippet text="yarn add @omni-stack/revai" dark />
  </Tab>

  <Tab>
    <Snippet text="bun add @omni-stack/revai" dark />
  </Tab>
</Tabs>
...
If you need a customized setup, you can import `createRevai` from `@omni-stack/revai` and create a provider instance with your settings:

```ts
import { createRevai } from '@omni-stack/revai';
