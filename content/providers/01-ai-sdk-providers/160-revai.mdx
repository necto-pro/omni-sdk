...
<Tabs items={['pnpm', 'npm', 'yarn', 'bun']}>
  <Tab>
    <Snippet text="pnpm add @open-stack/revai" dark />
  </Tab>
  <Tab>
    <Snippet text="npm install @open-stack/revai" dark />
  </Tab>
  <Tab>
    <Snippet text="yarn add @open-stack/revai" dark />
  </Tab>

  <Tab>
    <Snippet text="bun add @open-stack/revai" dark />
  </Tab>
</Tabs>
...
If you need a customized setup, you can import `createRevai` from `@open-stack/revai` and create a provider instance with your settings:

```ts
import { createRevai } from '@open-stack/revai';
