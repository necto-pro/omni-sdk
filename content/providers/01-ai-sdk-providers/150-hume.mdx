...
<Tabs items={['pnpm', 'npm', 'yarn', 'bun']}>
  <Tab>
    <Snippet text="pnpm add @omni-stack/hume" dark />
  </Tab>
  <Tab>
    <Snippet text="npm install @omni-stack/hume" dark />
  </Tab>
  <Tab>
    <Snippet text="yarn add @omni-stack/hume" dark />
  </Tab>

  <Tab>
    <Snippet text="bun add @omni-stack/hume" dark />
  </Tab>
</Tabs>
...
If you need a customized setup, you can import `createHume` from `@omni-stack/hume` and create a provider instance with your settings:

```ts
import { createHume } from '@omni-stack/hume';
