...
<Tabs items={['pnpm', 'npm', 'yarn', 'bun']}>
  <Tab>
    <Snippet text="pnpm add @open-stack/hume" dark />
  </Tab>
  <Tab>
    <Snippet text="npm install @open-stack/hume" dark />
  </Tab>
  <Tab>
    <Snippet text="yarn add @open-stack/hume" dark />
  </Tab>

  <Tab>
    <Snippet text="bun add @open-stack/hume" dark />
  </Tab>
</Tabs>
...
If you need a customized setup, you can import `createHume` from `@open-stack/hume` and create a provider instance with your settings:

```ts
import { createHume } from '@open-stack/hume';
