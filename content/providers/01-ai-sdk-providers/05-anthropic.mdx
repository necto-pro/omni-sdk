...
<Tabs items={['pnpm', 'npm', 'yarn', 'bun']}>
  <Tab>
    <Snippet text="pnpm add @omni-stack/anthropic" dark />
  </Tab>
  <Tab>
    <Snippet text="npm install @omni-stack/anthropic" dark />
  </Tab>
  <Tab>
    <Snippet text="yarn add @omni-stack/anthropic" dark />
  </Tab>

  <Tab>
    <Snippet text="bun add @omni-stack/anthropic" dark />
  </Tab>
</Tabs>
...
If you need a customized setup, you can import `createAnthropic` from `@omni-stack/anthropic` and create a provider instance with your settings:
