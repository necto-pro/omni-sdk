...
<Tabs items={['pnpm', 'npm', 'yarn', 'bun']}>
  <Tab>
    <Snippet text="pnpm add @open-stack/anthropic" dark />
  </Tab>
  <Tab>
    <Snippet text="npm install @open-stack/anthropic" dark />
  </Tab>
  <Tab>
    <Snippet text="yarn add @open-stack/anthropic" dark />
  </Tab>

  <Tab>
    <Snippet text="bun add @open-stack/anthropic" dark />
  </Tab>
</Tabs>
...
If you need a customized setup, you can import `createAnthropic` from `@open-stack/anthropic` and create a provider instance with your settings:
