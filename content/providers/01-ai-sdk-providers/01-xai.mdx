...
The xAI Grok provider is available via the `@open-stack/xai` module. You can
install it with

<Tabs items={['pnpm', 'npm', 'yarn', 'bun']}>
  <Tab>
    <Snippet text="pnpm add @open-stack/xai" dark />
  </Tab>
  <Tab>
    <Snippet text="npm install @open-stack/xai" dark />
  </Tab>
  <Tab>
    <Snippet text="yarn add @open-stack/xai" dark />
  </Tab>

  <Tab>
    <Snippet text="bun add @open-stack/xai" dark />
  </Tab>
</Tabs>
...
If you need a customized setup, you can import `createXai` from `@open-stack/xai`
and create a provider instance with your settings:

```ts
import { createXai } from '@open-stack/xai';
