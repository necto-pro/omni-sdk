...
The xAI Grok provider is available via the `@omni-stack/xai` module. You can
install it with

<Tabs items={['pnpm', 'npm', 'yarn', 'bun']}>
  <Tab>
    <Snippet text="pnpm add @omni-stack/xai" dark />
  </Tab>
  <Tab>
    <Snippet text="npm install @omni-stack/xai" dark />
  </Tab>
  <Tab>
    <Snippet text="yarn add @omni-stack/xai" dark />
  </Tab>

  <Tab>
    <Snippet text="bun add @omni-stack/xai" dark />
  </Tab>
</Tabs>
...
If you need a customized setup, you can import `createXai` from `@omni-stack/xai`
and create a provider instance with your settings:

```ts
import { createXai } from '@omni-stack/xai';
