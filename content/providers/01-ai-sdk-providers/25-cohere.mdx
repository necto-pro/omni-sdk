...
<Tabs items={['pnpm', 'npm', 'yarn', 'bun']}>
  <Tab>
    <Snippet text="pnpm add @open-stack/cohere" dark />
  </Tab>
  <Tab>
    <Snippet text="npm install @open-stack/cohere" dark />
  </Tab>
  <Tab>
    <Snippet text="yarn add @open-stack/cohere" dark />
  </Tab>

  <Tab>
    <Snippet text="bun add @open-stack/cohere" dark />
  </Tab>
</Tabs>
...
If you need a customized setup, you can import `createCohere` from `@open-stack/cohere`
