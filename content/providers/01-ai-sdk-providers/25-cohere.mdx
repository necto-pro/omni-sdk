...
<Tabs items={['pnpm', 'npm', 'yarn', 'bun']}>
  <Tab>
    <Snippet text="pnpm add @omni-stack/cohere" dark />
  </Tab>
  <Tab>
    <Snippet text="npm install @omni-stack/cohere" dark />
  </Tab>
  <Tab>
    <Snippet text="yarn add @omni-stack/cohere" dark />
  </Tab>

  <Tab>
    <Snippet text="bun add @omni-stack/cohere" dark />
  </Tab>
</Tabs>
...
If you need a customized setup, you can import `createCohere` from `@omni-stack/cohere`
