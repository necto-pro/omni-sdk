...
The Bedrock provider is available in the `@omni-stack/amazon-bedrock` module. You can install it with

<Tabs items={['pnpm', 'npm', 'yarn', 'bun']}>
  <Tab>
    <Snippet text="pnpm add @omni-stack/amazon-bedrock" dark />
  </Tab>
  <Tab>
    <Snippet text="npm install @omni-stack/amazon-bedrock" dark />
  </Tab>
  <Tab>
    <Snippet text="yarn add @omni-stack/amazon-bedrock" dark />
  </Tab>

  <Tab>
    <Snippet text="bun add @omni-stack/amazon-bedrock" dark />
  </Tab>
</Tabs>
...
If you need a customized setup, you can import `createAmazonBedrock` from `@omni-stack/amazon-bedrock` and create a provider instance with your settings:
...
## Migrating to `@omni-stack/amazon-bedrock` 2.x
