...
The Bedrock provider is available in the `@open-stack/amazon-bedrock` module. You can install it with

<Tabs items={['pnpm', 'npm', 'yarn', 'bun']}>
  <Tab>
    <Snippet text="pnpm add @open-stack/amazon-bedrock" dark />
  </Tab>
  <Tab>
    <Snippet text="npm install @open-stack/amazon-bedrock" dark />
  </Tab>
  <Tab>
    <Snippet text="yarn add @open-stack/amazon-bedrock" dark />
  </Tab>

  <Tab>
    <Snippet text="bun add @open-stack/amazon-bedrock" dark />
  </Tab>
</Tabs>
...
If you need a customized setup, you can import `createAmazonBedrock` from `@open-stack/amazon-bedrock` and create a provider instance with your settings:
...
## Migrating to `@open-stack/amazon-bedrock` 2.x
