...
The Replicate provider is available via the `@open-stack/replicate` module. You can install it with

<Tabs items={['pnpm', 'npm', 'yarn', 'bun']}>
  <Tab>
    <Snippet text="pnpm add @open-stack/replicate" dark />
  </Tab>
  <Tab>
    <Snippet text="npm install @open-stack/replicate" dark />
  </Tab>
  <Tab>
    <Snippet text="yarn add @open-stack/replicate" dark />
  </Tab>

  <Tab>
    <Snippet text="bun add @open-stack/replicate" dark />
  </Tab>
</Tabs>

## Provider Instance

You can import the default provider instance `replicate` from `@open-stack/replicate`:

```ts
import { replicate } from '@open-stack/replicate';
```

If you need a customized setup, you can import `createReplicate` from `@open-stack/replicate`
and create a provider instance with your settings:

```ts
import { createReplicate } from '@open-stack/replicate';
