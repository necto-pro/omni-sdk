...
The Replicate provider is available via the `@omni-stack/replicate` module. You can install it with

<Tabs items={['pnpm', 'npm', 'yarn', 'bun']}>
  <Tab>
    <Snippet text="pnpm add @omni-stack/replicate" dark />
  </Tab>
  <Tab>
    <Snippet text="npm install @omni-stack/replicate" dark />
  </Tab>
  <Tab>
    <Snippet text="yarn add @omni-stack/replicate" dark />
  </Tab>

  <Tab>
    <Snippet text="bun add @omni-stack/replicate" dark />
  </Tab>
</Tabs>

## Provider Instance

You can import the default provider instance `replicate` from `@omni-stack/replicate`:

```ts
import { replicate } from '@omni-stack/replicate';
```

If you need a customized setup, you can import `createReplicate` from `@omni-stack/replicate`
and create a provider instance with your settings:

```ts
import { createReplicate } from '@omni-stack/replicate';
