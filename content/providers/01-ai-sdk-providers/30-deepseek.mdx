...
The DeepSeek provider is available via the `@omni-stack/deepseek` module. You can install it with:

<Tabs items={['pnpm', 'npm', 'yarn', 'bun']}>
  <Tab>
    <Snippet text="pnpm add @omni-stack/deepseek" dark />
  </Tab>
  <Tab>
    <Snippet text="npm install @omni-stack/deepseek" dark />
  </Tab>
  <Tab>
    <Snippet text="yarn add @omni-stack/deepseek" dark />
  </Tab>

  <Tab>
    <Snippet text="bun add @omni-stack/deepseek" dark />
  </Tab>
</Tabs>
...
```ts
import { createDeepSeek } from '@omni-stack/deepseek';
