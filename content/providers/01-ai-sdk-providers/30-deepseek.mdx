...
The DeepSeek provider is available via the `@open-stack/deepseek` module. You can install it with:

<Tabs items={['pnpm', 'npm', 'yarn', 'bun']}>
  <Tab>
    <Snippet text="pnpm add @open-stack/deepseek" dark />
  </Tab>
  <Tab>
    <Snippet text="npm install @open-stack/deepseek" dark />
  </Tab>
  <Tab>
    <Snippet text="yarn add @open-stack/deepseek" dark />
  </Tab>

  <Tab>
    <Snippet text="bun add @open-stack/deepseek" dark />
  </Tab>
</Tabs>
...
```ts
import { createDeepSeek } from '@open-stack/deepseek';
