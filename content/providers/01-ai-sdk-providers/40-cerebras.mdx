...
The Cerebras provider is available via the `@open-stack/cerebras` module. You can install it with:

<Tabs items={['pnpm', 'npm', 'yarn', 'bun']}>
  <Tab>
    <Snippet text="pnpm add @open-stack/cerebras" dark />
  </Tab>
  <Tab>
    <Snippet text="npm install @open-stack/cerebras" dark />
  </Tab>
  <Tab>
    <Snippet text="yarn add @open-stack/cerebras" dark />
  </Tab>

  <Tab>
    <Snippet text="bun add @open-stack/cerebras" dark />
  </Tab>
</Tabs>
...
```ts
import { createCerebras } from '@open-stack/cerebras';
