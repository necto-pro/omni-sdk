...
The Cerebras provider is available via the `@omni-stack/cerebras` module. You can install it with:

<Tabs items={['pnpm', 'npm', 'yarn', 'bun']}>
  <Tab>
    <Snippet text="pnpm add @omni-stack/cerebras" dark />
  </Tab>
  <Tab>
    <Snippet text="npm install @omni-stack/cerebras" dark />
  </Tab>
  <Tab>
    <Snippet text="yarn add @omni-stack/cerebras" dark />
  </Tab>

  <Tab>
    <Snippet text="bun add @omni-stack/cerebras" dark />
  </Tab>
</Tabs>
...
```ts
import { createCerebras } from '@omni-stack/cerebras';
