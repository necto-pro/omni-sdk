...
<Tabs items={['pnpm', 'npm', 'yarn', 'bun']}>
  <Tab>
    <Snippet text="pnpm add @omni-stack/mistral" dark />
  </Tab>
  <Tab>
    <Snippet text="npm install @omni-stack/mistral" dark />
  </Tab>
  <Tab>
    <Snippet text="yarn add @omni-stack/mistral" dark />
  </Tab>

  <Tab>
    <Snippet text="bun add @omni-stack/mistral" dark />
  </Tab>
</Tabs>
...
If you need a customized setup, you can import `createMistral` from `@omni-stack/mistral`
