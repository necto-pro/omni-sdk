...
<Tabs items={['pnpm', 'npm', 'yarn', 'bun']}>
  <Tab>
    <Snippet text="pnpm add @open-stack/mistral" dark />
  </Tab>
  <Tab>
    <Snippet text="npm install @open-stack/mistral" dark />
  </Tab>
  <Tab>
    <Snippet text="yarn add @open-stack/mistral" dark />
  </Tab>

  <Tab>
    <Snippet text="bun add @open-stack/mistral" dark />
  </Tab>
</Tabs>
...
If you need a customized setup, you can import `createMistral` from `@open-stack/mistral`
