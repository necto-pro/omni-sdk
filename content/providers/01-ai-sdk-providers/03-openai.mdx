...
<Tabs items={['pnpm', 'npm', 'yarn', 'bun']}>
  <Tab>
    <Snippet text="pnpm add @open-stack/openai" dark />
  </Tab>
  <Tab>
    <Snippet text="npm install @open-stack/openai" dark />
  </Tab>
  <Tab>
    <Snippet text="yarn add @open-stack/openai" dark />
  </Tab>

  <Tab>
    <Snippet text="bun add @open-stack/openai" dark />
  </Tab>
</Tabs>
...
If you need a customized setup, you can import `createOpenAI` from `@open-stack/openai` and create a provider instance with your settings:
