...
<Tabs items={['pnpm', 'npm', 'yarn', 'bun']}>
  <Tab>
    <Snippet text="pnpm add @omni-stack/openai" dark />
  </Tab>
  <Tab>
    <Snippet text="npm install @omni-stack/openai" dark />
  </Tab>
  <Tab>
    <Snippet text="yarn add @omni-stack/openai" dark />
  </Tab>

  <Tab>
    <Snippet text="bun add @omni-stack/openai" dark />
  </Tab>
</Tabs>
...
If you need a customized setup, you can import `createOpenAI` from `@omni-stack/openai` and create a provider instance with your settings:
