...
The Together.ai provider is available via the `@open-stack/togetherai` module. You can
install it with

<Tabs items={['pnpm', 'npm', 'yarn', 'bun']}>
  <Tab>
    <Snippet text="pnpm add @open-stack/togetherai" dark />
  </Tab>
  <Tab>
    <Snippet text="npm install @open-stack/togetherai" dark />
  </Tab>
  <Tab>
    <Snippet text="yarn add @open-stack/togetherai" dark />
  </Tab>

  <Tab>
    <Snippet text="bun add @open-stack/togetherai" dark />
  </Tab>
</Tabs>
...
If you need a customized setup, you can import `createTogetherAI` from `@open-stack/togetherai`
and create a provider instance with your settings:

```ts
import { createTogetherAI } from '@open-stack/togetherai';
