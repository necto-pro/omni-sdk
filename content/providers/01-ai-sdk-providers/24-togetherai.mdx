...
The Together.ai provider is available via the `@omni-stack/togetherai` module. You can
install it with

<Tabs items={['pnpm', 'npm', 'yarn', 'bun']}>
  <Tab>
    <Snippet text="pnpm add @omni-stack/togetherai" dark />
  </Tab>
  <Tab>
    <Snippet text="npm install @omni-stack/togetherai" dark />
  </Tab>
  <Tab>
    <Snippet text="yarn add @omni-stack/togetherai" dark />
  </Tab>

  <Tab>
    <Snippet text="bun add @omni-stack/togetherai" dark />
  </Tab>
</Tabs>
...
If you need a customized setup, you can import `createTogetherAI` from `@omni-stack/togetherai`
and create a provider instance with your settings:

```ts
import { createTogetherAI } from '@omni-stack/togetherai';
