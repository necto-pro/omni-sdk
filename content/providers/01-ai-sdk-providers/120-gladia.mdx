...
<Tabs items={['pnpm', 'npm', 'yarn', 'bun']}>
  <Tab>
    <Snippet text="pnpm add @open-stack/gladia" dark />
  </Tab>
  <Tab>
    <Snippet text="npm install @open-stack/gladia" dark />
  </Tab>
  <Tab>
    <Snippet text="yarn add @open-stack/gladia" dark />
  </Tab>

  <Tab>
    <Snippet text="bun add @open-stack/gladia" dark />
  </Tab>
</Tabs>
...
If you need a customized setup, you can import `createGladia` from `@open-stack/gladia` and create a provider instance with your settings:

```ts
import { createGladia } from '@open-stack/gladia';
