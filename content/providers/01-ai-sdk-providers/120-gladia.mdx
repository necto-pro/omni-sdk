...
<Tabs items={['pnpm', 'npm', 'yarn', 'bun']}>
  <Tab>
    <Snippet text="pnpm add @omni-stack/gladia" dark />
  </Tab>
  <Tab>
    <Snippet text="npm install @omni-stack/gladia" dark />
  </Tab>
  <Tab>
    <Snippet text="yarn add @omni-stack/gladia" dark />
  </Tab>

  <Tab>
    <Snippet text="bun add @omni-stack/gladia" dark />
  </Tab>
</Tabs>
...
If you need a customized setup, you can import `createGladia` from `@omni-stack/gladia` and create a provider instance with your settings:

```ts
import { createGladia } from '@omni-stack/gladia';
