...
<Note>
  ...
  The Edge runtime is supported through the `@omni-stack/google-vertex/edge`
...
The Google Vertex and Google Vertex Anthropic providers are both available in the `@omni-stack/google-vertex` module. You can install it with

<Tabs items={['pnpm', 'npm', 'yarn', 'bun']}>
  <Tab>
    <Snippet text="pnpm add @omni-stack/google-vertex" dark />
  </Tab>
  <Tab>
    <Snippet text="npm install @omni-stack/google-vertex" dark />
  </Tab>
  <Tab>
    <Snippet
      text="yarn add @omni-stack/google-vertex @google-cloud/vertexai"
      dark
    />
  </Tab>

  <Tab>
    <Snippet text="bun add @omni-stack/google-vertex" dark />
  </Tab>
</Tabs>
...
You can import the default provider instance `vertex` from `@omni-stack/google-vertex`:

```ts
import { vertex } from '@omni-stack/google-vertex';
```

If you need a customized setup, you can import `createVertex` from `@omni-stack/google-vertex` and create a provider instance with your settings:
...
You can import the default provider instance `vertex` from `@omni-stack/google-vertex/edge`:
...
<Note>
  The `/edge` sub-module is included in the `@omni-stack/google-vertex` package, so
  you don't need to install it separately. You must import from
  `@omni-stack/google-vertex/edge` to differentiate it from the Node.js provider.
</Note>

If you need a customized setup, you can import `createVertex` from `@omni-stack/google-vertex/edge` and create a provider instance with your settings:
...
```ts
import { vertex } from '@omni-stack/google-vertex';
import { GoogleGenerativeAIProviderOptions } from '@omni-stack/google'; // Note: importing from @omni-stack/google
...
```ts
import { vertex } from '@omni-stack/google-vertex';
import { GoogleVertexImageProviderOptions } from '@omni-stack/google-vertex';
import { experimental_generateImage as generateImage } from '@omni-stack/core';
...
You can import the default provider instance `vertexAnthropic` from `@omni-stack/google-vertex/anthropic`:

```typescript
import { vertexAnthropic } from '@omni-stack/google-vertex/anthropic';
```

If you need a customized setup, you can import `createVertexAnthropic` from `@omni-stack/google-vertex/anthropic` and create a provider instance with your settings:
...
For Edge runtimes, you can import the provider instance from `@omni-stack/google-vertex/anthropic/edge`:
...
```typescript
import { createVertexAnthropic } from '@omni-stack/google-vertex/anthropic/edge';
