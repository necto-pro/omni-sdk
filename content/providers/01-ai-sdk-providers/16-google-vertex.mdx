...
<Note>
  ...
  The Edge runtime is supported through the `@open-stack/google-vertex/edge`
...
The Google Vertex and Google Vertex Anthropic providers are both available in the `@open-stack/google-vertex` module. You can install it with

<Tabs items={['pnpm', 'npm', 'yarn', 'bun']}>
  <Tab>
    <Snippet text="pnpm add @open-stack/google-vertex" dark />
  </Tab>
  <Tab>
    <Snippet text="npm install @open-stack/google-vertex" dark />
  </Tab>
  <Tab>
    <Snippet
      text="yarn add @open-stack/google-vertex @google-cloud/vertexai"
      dark
    />
  </Tab>

  <Tab>
    <Snippet text="bun add @open-stack/google-vertex" dark />
  </Tab>
</Tabs>
...
You can import the default provider instance `vertex` from `@open-stack/google-vertex`:

```ts
import { vertex } from '@open-stack/google-vertex';
```

If you need a customized setup, you can import `createVertex` from `@open-stack/google-vertex` and create a provider instance with your settings:
...
You can import the default provider instance `vertex` from `@open-stack/google-vertex/edge`:
...
<Note>
  The `/edge` sub-module is included in the `@open-stack/google-vertex` package, so
  you don't need to install it separately. You must import from
  `@open-stack/google-vertex/edge` to differentiate it from the Node.js provider.
</Note>

If you need a customized setup, you can import `createVertex` from `@open-stack/google-vertex/edge` and create a provider instance with your settings:
...
```ts
import { vertex } from '@open-stack/google-vertex';
import { GoogleGenerativeAIProviderOptions } from '@open-stack/google'; // Note: importing from @open-stack/google
...
```ts
import { vertex } from '@open-stack/google-vertex';
import { GoogleVertexImageProviderOptions } from '@open-stack/google-vertex';
import { experimental_generateImage as generateImage } from 'ai';
...
You can import the default provider instance `vertexAnthropic` from `@open-stack/google-vertex/anthropic`:

```typescript
import { vertexAnthropic } from '@open-stack/google-vertex/anthropic';
```

If you need a customized setup, you can import `createVertexAnthropic` from `@open-stack/google-vertex/anthropic` and create a provider instance with your settings:
...
For Edge runtimes, you can import the provider instance from `@open-stack/google-vertex/anthropic/edge`:
...
```typescript
import { createVertexAnthropic } from '@open-stack/google-vertex/anthropic/edge';
