...
<Tabs items={['pnpm', 'npm', 'yarn', 'bun']}>
  <Tab>
    <Snippet text="pnpm add @open-stack/assemblyai" dark />
  </Tab>
  <Tab>
    <Snippet text="npm install @open-stack/assemblyai" dark />
  </Tab>
  <Tab>
    <Snippet text="yarn add @open-stack/assemblyai" dark />
  </Tab>

  <Tab>
    <Snippet text="bun add @open-stack/assemblyai" dark />
  </Tab>
</Tabs>
...
If you need a customized setup, you can import `createAssemblyAI` from `@open-stack/assemblyai` and create a provider instance with your settings:

```ts
import { createAssemblyAI } from '@open-stack/assemblyai';
