...
<Tabs items={['pnpm', 'npm', 'yarn', 'bun']}>
  <Tab>
    <Snippet text="pnpm add @omni-stack/assemblyai" dark />
  </Tab>
  <Tab>
    <Snippet text="npm install @omni-stack/assemblyai" dark />
  </Tab>
  <Tab>
    <Snippet text="yarn add @omni-stack/assemblyai" dark />
  </Tab>

  <Tab>
    <Snippet text="bun add @omni-stack/assemblyai" dark />
  </Tab>
</Tabs>
...
If you need a customized setup, you can import `createAssemblyAI` from `@omni-stack/assemblyai` and create a provider instance with your settings:

```ts
import { createAssemblyAI } from '@omni-stack/assemblyai';
