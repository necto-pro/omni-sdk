...
<Tabs items={['pnpm', 'npm', 'yarn', 'bun']}>
  <Tab>
    <Snippet text="pnpm add @open-stack/elevenlabs" dark />
  </Tab>
  <Tab>
    <Snippet text="npm install @open-stack/elevenlabs" dark />
  </Tab>
  <Tab>
    <Snippet text="yarn add @open-stack/elevenlabs" dark />
  </Tab>

  <Tab>
    <Snippet text="bun add @open-stack/elevenlabs" dark />
  </Tab>
</Tabs>
...
If you need a customized setup, you can import `createElevenLabs` from `@open-stack/elevenlabs` and create a provider instance with your settings:

```ts
import { createElevenLabs } from '@open-stack/elevenlabs';
