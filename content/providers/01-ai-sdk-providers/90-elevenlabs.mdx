...
<Tabs items={['pnpm', 'npm', 'yarn', 'bun']}>
  <Tab>
    <Snippet text="pnpm add @omni-stack/elevenlabs" dark />
  </Tab>
  <Tab>
    <Snippet text="npm install @omni-stack/elevenlabs" dark />
  </Tab>
  <Tab>
    <Snippet text="yarn add @omni-stack/elevenlabs" dark />
  </Tab>

  <Tab>
    <Snippet text="bun add @omni-stack/elevenlabs" dark />
  </Tab>
</Tabs>
...
If you need a customized setup, you can import `createElevenLabs` from `@omni-stack/elevenlabs` and create a provider instance with your settings:

```ts
import { createElevenLabs } from '@omni-stack/elevenlabs';
