...
The Hugging Face provider is available via the `@open-stack/huggingface` module. You can install it with:

<Tabs items={['pnpm', 'npm', 'yarn', 'bun']}>
  <Tab>
    <Snippet text="pnpm add @open-stack/huggingface" dark />
  </Tab>
  <Tab>
    <Snippet text="npm install @open-stack/huggingface" dark />
  </Tab>
  <Tab>
    <Snippet text="yarn add @open-stack/huggingface" dark />
  </Tab>

  <Tab>
    <Snippet text="bun add @open-stack/huggingface" dark />
  </Tab>
</Tabs>
...
```ts
import { createHuggingFace } from '@open-stack/huggingface';
