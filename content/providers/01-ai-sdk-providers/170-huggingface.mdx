...
The Hugging Face provider is available via the `@omni-stack/huggingface` module. You can install it with:

<Tabs items={['pnpm', 'npm', 'yarn', 'bun']}>
  <Tab>
    <Snippet text="pnpm add @omni-stack/huggingface" dark />
  </Tab>
  <Tab>
    <Snippet text="npm install @omni-stack/huggingface" dark />
  </Tab>
  <Tab>
    <Snippet text="yarn add @omni-stack/huggingface" dark />
  </Tab>

  <Tab>
    <Snippet text="bun add @omni-stack/huggingface" dark />
  </Tab>
</Tabs>
...
```ts
import { createHuggingFace } from '@omni-stack/huggingface';
