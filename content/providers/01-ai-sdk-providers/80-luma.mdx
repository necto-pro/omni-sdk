...
The Luma provider is available via the `@open-stack/luma` module. You can install it with

<Tabs items={['pnpm', 'npm', 'yarn', 'bun']}>
  <Tab>
    <Snippet text="pnpm add @open-stack/luma" dark />
  </Tab>
  <Tab>
    <Snippet text="npm install @open-stack/luma" dark />
  </Tab>
  <Tab>
    <Snippet text="yarn add @open-stack/luma" dark />
  </Tab>

  <Tab>
    <Snippet text="bun add @open-stack/luma" dark />
  </Tab>
</Tabs>
...
```ts
import { createLuma } from '@open-stack/luma';
