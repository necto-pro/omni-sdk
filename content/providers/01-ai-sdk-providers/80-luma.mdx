...
The Luma provider is available via the `@omni-stack/luma` module. You can install it with

<Tabs items={['pnpm', 'npm', 'yarn', 'bun']}>
  <Tab>
    <Snippet text="pnpm add @omni-stack/luma" dark />
  </Tab>
  <Tab>
    <Snippet text="npm install @omni-stack/luma" dark />
  </Tab>
  <Tab>
    <Snippet text="yarn add @omni-stack/luma" dark />
  </Tab>

  <Tab>
    <Snippet text="bun add @omni-stack/luma" dark />
  </Tab>
</Tabs>
...
```ts
import { createLuma } from '@omni-stack/luma';
