...
The Vercel provider is available via the `@omni-stack/vercel` module. You can install it with:

<Tabs items={['pnpm', 'npm', 'yarn', 'bun']}>
  <Tab>
    <Snippet text="pnpm add @omni-stack/vercel" dark />
  </Tab>
  <Tab>
    <Snippet text="npm install @omni-stack/vercel" dark />
  </Tab>
  <Tab>
    <Snippet text="yarn add @omni-stack/vercel" dark />
  </Tab>

  <Tab>
    <Snippet text="bun add @omni-stack/vercel" dark />
  </Tab>
</Tabs>
...
If you need a customized setup, you can import `createVercel` from `@omni-stack/vercel` and create a provider instance with your settings:

```ts
import { createVercel } from '@omni-stack/vercel';
