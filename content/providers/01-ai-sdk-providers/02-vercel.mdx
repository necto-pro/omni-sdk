...
The Vercel provider is available via the `@open-stack/vercel` module. You can install it with:

<Tabs items={['pnpm', 'npm', 'yarn', 'bun']}>
  <Tab>
    <Snippet text="pnpm add @open-stack/vercel" dark />
  </Tab>
  <Tab>
    <Snippet text="npm install @open-stack/vercel" dark />
  </Tab>
  <Tab>
    <Snippet text="yarn add @open-stack/vercel" dark />
  </Tab>

  <Tab>
    <Snippet text="bun add @open-stack/vercel" dark />
  </Tab>
</Tabs>
...
If you need a customized setup, you can import `createVercel` from `@open-stack/vercel` and create a provider instance with your settings:

```ts
import { createVercel } from '@open-stack/vercel';
