...
The Groq provider is available via the `@omni-stack/groq` module.
You can install it with

<Tabs items={['pnpm', 'npm', 'yarn', 'bun']}>
  <Tab>
    <Snippet text="pnpm add @omni-stack/groq" dark />
  </Tab>
  <Tab>
    <Snippet text="npm install @omni-stack/groq" dark />
  </Tab>
  <Tab>
    <Snippet text="yarn add @omni-stack/groq" dark />
  </Tab>

  <Tab>
    <Snippet text="bun add @omni-stack/groq" dark />
  </Tab>
</Tabs>
...
If you need a customized setup, you can import `createGroq` from `@omni-stack/groq`
and create a provider instance with your settings:

```ts
import { createGroq } from '@omni-stack/groq';
