...
The Groq provider is available via the `@open-stack/groq` module.
You can install it with

<Tabs items={['pnpm', 'npm', 'yarn', 'bun']}>
  <Tab>
    <Snippet text="pnpm add @open-stack/groq" dark />
  </Tab>
  <Tab>
    <Snippet text="npm install @open-stack/groq" dark />
  </Tab>
  <Tab>
    <Snippet text="yarn add @open-stack/groq" dark />
  </Tab>

  <Tab>
    <Snippet text="bun add @open-stack/groq" dark />
  </Tab>
</Tabs>
...
If you need a customized setup, you can import `createGroq` from `@open-stack/groq`
and create a provider instance with your settings:

```ts
import { createGroq } from '@open-stack/groq';
