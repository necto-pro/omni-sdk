...
<Tabs items={['pnpm', 'npm', 'yarn', 'bun']}>
  <Tab>
    <Snippet text="pnpm add @open-stack/openai langsmith" dark />
  </Tab>
  <Tab>
    <Snippet text="npm install @open-stack/openai langsmith" dark />
  </Tab>
  <Tab>
    <Snippet text="yarn add @open-stack/openai langsmith" dark />
  </Tab>
  <Tab>
    <Snippet text="bun add @open-stack/openai langsmith" dark />
  </Tab>
</Tabs>
