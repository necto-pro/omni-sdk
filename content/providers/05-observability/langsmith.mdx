...
<Tabs items={['pnpm', 'npm', 'yarn', 'bun']}>
  <Tab>
    <Snippet text="pnpm add @omni-stack/openai langsmith" dark />
  </Tab>
  <Tab>
    <Snippet text="npm install @omni-stack/openai langsmith" dark />
  </Tab>
  <Tab>
    <Snippet text="yarn add @omni-stack/openai langsmith" dark />
  </Tab>
  <Tab>
    <Snippet text="bun add @omni-stack/openai langsmith" dark />
  </Tab>
</Tabs>
...
import * as ai from '@omni-stack/core';
...
```ts
import * as ai from '@omni-stack/core';
import { tool, stepCountIs } from '@omni-stack/core';
import { openai } from '@omni-stack/openai';
import { z } from 'zod';
