...
<div className="my-4">
  <Tabs items={['pnpm', 'npm', 'yarn', 'bun']}>
    <Tab>
      <Snippet text="pnpm add ai @open-stack/openai @open-stack/vue zod" dark />
    </Tab>
    <Tab>
      <Snippet text="npm install ai @open-stack/openai @open-stack/vue zod" dark />
    </Tab>
    <Tab>
      <Snippet text="yarn add ai @open-stack/openai @open-stack/vue zod" dark />
    </Tab>

    <Tab>
      <Snippet text="bun add ai @open-stack/openai @open-stack/vue zod" dark />
    </Tab>
