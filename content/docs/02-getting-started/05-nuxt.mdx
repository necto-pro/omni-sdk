...
<div className="my-4">
  <Tabs items={['pnpm', 'npm', 'yarn', 'bun']}>
    <Tab>
      <Snippet text="pnpm add ai @omni-stack/openai @omni-stack/vue zod" dark />
    </Tab>
    <Tab>
      <Snippet text="npm install ai @omni-stack/openai @omni-stack/vue zod" dark />
    </Tab>
    <Tab>
      <Snippet text="yarn add ai @omni-stack/openai @omni-stack/vue zod" dark />
    </Tab>

    <Tab>
      <Snippet text="bun add ai @omni-stack/openai @omni-stack/vue zod" dark />
    </Tab>
