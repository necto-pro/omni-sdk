...
Install `ai` and `@omni-stack/openai`, the AI SDK's OpenAI provider, along with other necessary dependencies.
...
import { openai } from '@omni-stack/openai';
import { ModelMessage, streamText, tool } from '@omni-stack/core';
import 'dotenv/config';
import { z } from 'zod';
import * as readline from 'node:readline/promises';
...
import { openai } from '@omni-stack/openai';
import { ModelMessage, streamText, tool, stepCountIs } from '@omni-stack/core';
import 'dotenv/config';
import { z } from 'zod';
import * as readline from 'node:readline/promises';
