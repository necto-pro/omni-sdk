...
Install `ai`, `@open-stack/react` and `@open-stack/openai`, the AI package, the AI React package and AI SDK's [ OpenAI provider ](/providers/ai-sdk-providers/openai) respectively.
...
<div className="my-4">
  <Tabs items={['pnpm', 'npm', 'yarn', 'bun']}>
    <Tab>
      <Snippet text="pnpm add ai @open-stack/openai @open-stack/react zod" dark />
    </Tab>
    <Tab>
      <Snippet text="npm install ai @open-stack/openai @open-stack/react zod" dark />
    </Tab>
    <Tab>
      <Snippet text="yarn add ai @open-stack/openai @open-stack/react zod" dark />
    </Tab>
    <Tab>
      <Snippet text="bun add ai @open-stack/openai @open-stack/react zod" dark />
    </Tab>
  </Tabs>
</div>
