...
Install `ai` and `@open-stack/openai`, the AI SDK's OpenAI provider.
...
<div className="my-4">
  <Tabs items={['pnpm', 'npm', 'yarn', 'bun']}>
    <Tab>
      <Snippet text="pnpm add -D ai @open-stack/openai @open-stack/svelte zod" dark />
    </Tab>
    <Tab>
      <Snippet
        text="npm install -D ai @open-stack/openai @open-stack/svelte zod"
        dark
      />
    </Tab>
    <Tab>
      <Snippet text="yarn add -D ai @open-stack/openai @open-stack/svelte zod" dark />
    </Tab>
    <Tab>
      <Snippet text="bun add -d ai @open-stack/openai @open-stack/svelte zod" dark />
    </Tab>
  </Tabs>
</div>
...
1. Create an OpenAI provider instance with the `createOpenAI` function from the `@open-stack/openai` package.
...
## How does `@open-stack/svelte` differ from `@open-stack/react`?
