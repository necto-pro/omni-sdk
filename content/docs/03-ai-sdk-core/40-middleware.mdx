...
```ts
import { wrapLanguageModel, simulateStreamingMiddleware } from '@omni-stack/core';
...
```ts
import { wrapLanguageModel, defaultSettingsMiddleware } from '@omni-stack/core';
...
The `@omni-stack-tool/parser` package offers three middleware variants:
...
```ts
import { wrapLanguageModel } from '@omni-stack/core';
import { gemmaToolMiddleware } from '@omni-stack-tool/parser';
...
```ts
import type { LanguageModelV3Middleware } from '@omni-stack/provider';
