...
```ts
import { openai as originalOpenAI } from '@omni-stack/openai';
import {
  customProvider,
...
```ts
import { anthropic as originalAnthropic } from '@omni-stack/anthropic';
import { customProvider } from '@omni-stack/core';
...
import { createProviderRegistry } from '@omni-stack/core';
