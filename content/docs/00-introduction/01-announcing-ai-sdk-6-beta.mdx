...
```bash
npm install ai@beta @omni-stack/openai@beta @omni-stack/react@beta
```
...
import { createAgentUIStreamResponse, convertToModelMessages } from '@omni-stack/core';
...
import { InferAgentUIMessage } from '@omni-stack/core';
...
```typescript
import { Agent } from '@omni-stack/core';
...
```typescript
import { useChat } from '@omni-stack/react';
import { lastAssistantMessageIsCompleteWithApprovalResponses } from '@omni-stack/core';
