...
- `ai-sdk/*` packages: `1.0.*` (other `@omni-stack` packages)
...
```sh
npx @omni-stack/codemod v4/replace-baseurl src/
```
...
```ts filename="AI SDK 3.4"
import { ExperimentalTool } from '@omni-stack/core';
```
...
```ts filename="AI SDK 3.4"
import { experimental_Provider, experimental_ProviderRegistry } from '@omni-stack/core';
```

```ts filename="AI SDK 4.0"
import { Provider } from '@omni-stack/core';
```
...
```ts filename="AI SDK 3.4"
import { experimental_createModelRegistry } from '@omni-stack/core';
```

```ts filename="AI SDK 4.0"
import { experimental_createProviderRegistry } from '@omni-stack/core';
```
...
```ts filename="AI SDK 3.4"
import { LanguageModelResponseMetadataWithHeaders } from '@omni-stack/core';
```

```ts filename="AI SDK 4.0"
import { LanguageModelResponseMetadata } from '@omni-stack/core';
```
...
import { render } from '@omni-stack/rsc';
```

```ts filename="AI SDK 4.0"
import { streamUI } from '@omni-stack/rsc';
```
...
You need to install the `@omni-stack/svelte`, `@omni-stack/vue`, and `@omni-stack/solid` packages directly.
...
```ts filename="AI SDK 3.4"
import { experimental_StreamData } from '@omni-stack/core';
```
...
```ts filename="AI SDK 3.4"
import { experimental_useAssistant } from '@omni-stack/react';
```
...
```ts filename="AI SDK 3.4"
import { experimental_AssistantResponse } from '@omni-stack/core';
```

```ts filename="AI SDK 4.0"
import { AssistantResponse } from '@omni-stack/core';
```
