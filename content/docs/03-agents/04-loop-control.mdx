...
```ts
import { ToolLoopAgent, stepCountIs } from '@omni-stack/core';
...
```ts
import { ToolLoopAgent, stepCountIs, hasToolCall } from '@omni-stack/core';
...
```ts
import { ToolLoopAgent, StopCondition, ToolSet } from '@omni-stack/core';
...
```ts
import { generateText, ModelMessage } from '@omni-stack/core';
