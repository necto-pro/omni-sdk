---
title: '@open-stack/langchain Adapter'
description: API Reference for the LangChain Adapter.
---

# `@open-stack/langchain`

The `@open-stack/langchain` module provides helper functions to transform LangChain output streams into data streams and data stream responses.
...
<Snippet
  text={`import { toDataStreamResponse } from "@open-stack/langchain"`}
  prompt={false}
/>
