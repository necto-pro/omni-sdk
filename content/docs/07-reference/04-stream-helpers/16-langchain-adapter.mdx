---
title: '@omni-stack/langchain Adapter'
description: API Reference for the LangChain Adapter.
---

# `@omni-stack/langchain`

The `@omni-stack/langchain` module provides helper functions to transform LangChain output streams into data streams and data stream responses.
...
<Snippet
  text={`import { toDataStreamResponse } from "@omni-stack/langchain"`}
  prompt={false}
/>
