---
title: '@omni-stack/llamaindex Adapter'
description: API Reference for the LlamaIndex Adapter.
---

# `@omni-stack/llamaindex`

The `@omni-stack/llamaindex` package provides helper functions to transform LlamaIndex output streams into data streams and data stream responses.
...
<Snippet
  text={`import { toDataResponse } from "@omni-stack/llamaindex"`}
  prompt={false}
/>
...
import { toDataStreamResponse } from '@omni-stack/llamaindex';
