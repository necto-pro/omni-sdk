---
title: '@open-stack/llamaindex Adapter'
description: API Reference for the LlamaIndex Adapter.
---

# `@open-stack/llamaindex`

The `@open-stack/llamaindex` package provides helper functions to transform LlamaIndex output streams into data streams and data stream responses.
...
<Snippet
  text={`import { toDataResponse } from "@open-stack/llamaindex"`}
  prompt={false}
/>
...
import { toDataStreamResponse } from '@open-stack/llamaindex';
